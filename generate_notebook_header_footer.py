...
if __name__ == "__main__":
    try:    
        nb_name = sys.argv[1]
        print("""*This post was entirely written using the Jupyter Notebook. Its content is BSD-licensed. You can see a static view or download this notebook with the help of nbviewer at [{0}]({1}).*""".format(nb_name, filename2url(nb_name)))
